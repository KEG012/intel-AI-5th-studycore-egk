...
from tensorflow.keras import datasets, layers, models, Model, Sequential, utils
...
'''
dataset_url = "https://ai.stanford.edu/~jkrause/cars/car_dataset.html"
data_dir = utils.get_file(origin = dataset_url, fname='car_photos', untar=True)
...
with open('Cars_data_CNN', 'wb') as file_pi:
    pickle.dump(history.history, file_pi)

history.save('Cars_data_CNN.h5')
